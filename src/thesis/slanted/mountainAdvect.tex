...
\TODO{ripped lots out into tfAdvect section, needs rejigging}
A velocity field is chosen that follows the terrain at the surface and becomes entirely horizontal aloft.
The velocity field becomes purely horizontal above $H_1 = \SI{10}{\kilo\meter}$.
...
\TODO{An analytic solution at \SI{10000}{\second} is obtained by calculating the new horizontal position of the tracer.  
By solving this equation we find that \(x(t=\SI{10000}{\second}) = \SI{123}{\meter}\) when $h_0 = \SI{5}{\kilo\meter}$.}
...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		...
		$\ell_2 = \input{mountainAdvect-h0-btf-1000-5000m-linearUpwind/10000/l2errorT}$
		$\ell_\infty = \input{mountainAdvect-h0-btf-1000-5000m-linearUpwind/10000/linferrorT}$
		$\ell_2 = \input{mountainAdvect-h0-cutCell-1000-5000m-linearUpwind/10000/l2errorT}$
		$\ell_\infty = \input{mountainAdvect-h0-cutCell-1000-5000m-linearUpwind/10000/linferrorT}$
		$\ell_2 = \input{mountainAdvect-h0-slantedCell-1000-5000m-linearUpwind/10000/l2errorT}$
		$\ell_\infty = \input{mountainAdvect-h0-slantedCell-1000-5000m-linearUpwind/10000/linferrorT}$
	\end{subfigure}
	\begin{subfigure}{\textwidth}
		...
		$\ell_2 = \input{mountainAdvect-h0-btf-1000-5000m-cubicFit/10000/l2errorT}$
		$\ell_\infty = \input{mountainAdvect-h0-btf-1000-5000m-cubicFit/10000/linferrorT}$
		$\ell_2 = \input{mountainAdvect-h0-cutCell-1000-5000m-cubicFit/10000/l2errorT}$
		$\ell_\infty = \input{mountainAdvect-h0-cutCell-1000-5000m-cubicFit/10000/linferrorT}$
		$\ell_2 = \input{mountainAdvect-h0-slantedCell-1000-5000m-cubicFit/10000/l2errorT}$
		$\ell_\infty = \input{mountainAdvect-h0-slantedCell-1000-5000m-cubicFit/10000/linferrorT}$
	\end{subfigure}
