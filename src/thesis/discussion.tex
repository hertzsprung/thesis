...
\TODO{Third, spherical geometry.
\citet{sjoegreen2012} might provide us with some inspiration here,  but really we need an extension of the methods of \citet{tuzikov2003} for spherical polynomials.
}
