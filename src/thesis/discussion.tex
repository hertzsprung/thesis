...
The test is based on the original specification by \citet{arakawa-konor1996}, developed for a simplified, vertically-discrete model in pressure coordinates.
