...
\TODO{It is the balance between pressure gradient and gravity that is more accurate with cells aligned or perpendicular to gravity}
...
\TODO{Or improve the balance between pressure gradient and gravity and reduce the spurious solenoidal term by using a curl-free gradient formulation \citep{weller-shahrokhi2014}}
