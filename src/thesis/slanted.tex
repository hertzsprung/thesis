...
This chapter seeks to reduce errors associated with the balance between the pressure gradient and gravity by representing the atmosphere above terrain using a new type of mesh, the slanted cell mesh.
