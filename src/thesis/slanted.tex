...
Another approach is to improve the balance between pressure gradient and gravity by reducing the spurious solenoidal term using a curl-free gradient formulation \citep{thuburn-cotter2012}, and this formulation was included in the nonhydrostatic model by \citet{weller-shahrokhi2014}.
