...
\TODO{
\begin{itemize}
	\item Conclusion: 2nd-order convergence
	\item Conclusion: numerical errors are due either to grid distortions, or misalignment of the flow with the mesh
\end{itemize}
}
...
Numerical errors and numerical convergence results are compared using the linearUpwind and cubicFit transport schemes.
...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		...
		$\ell_2 = \input{schaerAdvect-btf-1000-linearUpwind/10000/l2errorT}$
		$\ell_\infty = \input{schaerAdvect-btf-1000-linearUpwind/10000/linferrorT}$
		$\ell_2 = \input{schaerAdvect-cutCell-1000-linearUpwind/10000/l2errorT}$
		$\ell_\infty = \input{schaerAdvect-cutCell-1000-linearUpwind/10000/linferrorT}$
	...
	\begin{subfigure}{\textwidth}
		...
		$\ell_2 = \input{schaerAdvect-btf-1000-cubicFit/10000/l2errorT}$
		$\ell_\infty = \input{schaerAdvect-btf-1000-cubicFit/10000/linferrorT}$
		$\ell_2 = \input{schaerAdvect-cutCell-1000-cubicFit/10000/l2errorT}$
		$\ell_\infty = \input{schaerAdvect-cutCell-1000-cubicFit/10000/linferrorT}$
	\end{subfigure}
	\begin{subfigure}{\textwidth}
		...
		$\ell_2 = \input{tfAdvect-btf-1000-linearUpwind/10000/l2errorT}$
		$\ell_\infty = \input{tfAdvect-btf-1000-linearUpwind/10000/linferrorT}$
		$\ell_2 = \input{tfAdvect-cutCell-1000-linearUpwind/10000/l2errorT}$
		$\ell_\infty = \input{tfAdvect-cutCell-1000-linearUpwind/10000/linferrorT}$
	\end{subfigure}
	\begin{subfigure}{\textwidth}
		...
		$\ell_2 = \input{tfAdvect-btf-1000-cubicFit/10000/l2errorT}$
		$\ell_\infty = \input{tfAdvect-btf-1000-cubicFit/10000/linferrorT}$
		$\ell_2 = \input{tfAdvect-cutCell-1000-cubicFit/10000/l2errorT}$
		$\ell_\infty = \input{tfAdvect-cutCell-1000-cubicFit/10000/linferrorT}$
	\end{subfigure}
	\caption{\TODO{numerical and analytic tracer contours, error heatmap for schaerAdvect and tfAdvect}}
...
The test was performed using the linearUpwind and cubicFit transport schemes on BTF and cut cell meshes with $\Delta x = \SI{1000}{\meter}$, $\Delta z = \SI{500}{\meter}$.  To obtain a maximum Courant number of about \num{0.4}, $\Delta t = \SI{40}{\second}$ on the cut cell mesh where the flow is aligned with the mesh layers and there are no fluxes through upper and lower cell faces.
On the BTF mesh, $\Delta t$ is only \SI{8}{\second} because the flow is misaligned the mesh layers, with fluxes through all four faces of cells above sloping terrain.
...
In contrast, the linearUpwind scheme produces a more reasonable solution on the cut cell mesh, with only small phase errors apparent in figure~\ref{fig:cubicFit:schaerAdvect:error:cutCell:linearUpwind}.
