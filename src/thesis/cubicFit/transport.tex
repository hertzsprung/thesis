...
The transport of a \rev{tracer density} $\phi$ in a prescribed, non-divergent velocity field $\vect{u}$ is given by the \rev{flux-form equation \citep{nair-lauritzen2010}}
\begin{align}		
