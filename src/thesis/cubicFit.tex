...
\TODO{I've used the term 'swept-area' rather than 'swept-volume' which implies a 2D problem rather than 3D}
...
and method-of-lines schemes (also called Eulerian schemes).  \TODO{I haven't mentioned grid-point semi-Lagrangian, but then this list is not exhaustive}
...
\TODO{this approach has similarities to Multidimensional Optimal Order Detection \citep{clain2011,diot2013}, but our method only needs the mesh geometry}
...
\TODO{more introduction to the test cases here?}
