...
\rev{Cut cells are also known as shaved cells \citep{adcroft1997,adcroft2013} or embedded boundaries \citep{schwartz2015, devendran2017}.}
...
For the numerical test cases presented, we also supply the source code \citep{atmostests} and \rev{resulting} data \citep{atmostests-results}.
