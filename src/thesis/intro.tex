...
Chapter~\ref{ch:cp} extends the work of \citep{arakawa-konor1996} to create new two-dimensional test case that excites the Lorenz computational mode, enabling a more straightforward assessment of models using collocated variables, a Lorenz staggering or a Charney--Phillips staggering.
