...
Chapter~\ref{ch:highOrder} proposes a modification to the formulation, using techniques from \citet{devendran2017} \TODO{k-exact method is much older, maybe cite \citet{barth1995}, too} to achieve higher than second-order convergence in the interior of distorted meshes without increasing the computational cost during integration.
