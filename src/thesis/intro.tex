...
Terrain-following meshes have been in widespread operational use since atmospheric models first included a numerical representation of terrain \citep{steppeler2003}, with the basic terrain-following mesh having been formulated by \citet{galchen-somerville1975a}. \TODO{sigma coordinates \citep{phillips1957} came earlier than BTF but I'm not sure of the difference?}
...
This thesis makes three contributions to improve numerical accuracy for flows over steep slopes on arbitrary meshes: a new transport scheme, a new vertical mesh, and a new test case to excite the Lorenz computational mode.
\TODO{We use OpenFOAM [citation] to enable like-for-like comparisons between different model variants and different types of mesh.  Code and data are available at zenodo etc...}
