...
First, a new type of mesh, the `slanted cell mesh', avoids severe mesh distortions associated with terrain-following meshes and avoids severe time-step constraints associated with cut cells.
Numerical experiments to compare terrain-following, cut cell, and slanted cell meshes reveal that the slanted cell mesh simultaneously achieves an accurate balance between the pressure gradient and gravity, and avoids severe time-step constraints. 

Second, a new two-dimensional test case is proposed that excites the Lorenz computational mode.
...
Third, a multidimensional transport scheme is formulated to obtain accurate solutions on arbitrary, highly-distorted meshes.
...
The scheme achieves second-order convergence across a series of tests using highly-distorted terrain-following meshes, cut cell and slanted cell meshes.
