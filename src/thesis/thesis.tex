...
\TODO{
\begin{itemize}
	\item meshes: uniform, non-conformal (block refinement), conformal
	\item models: ExnerFoamH and ExnerFoamCP
	\item CP advection schemes: something feeble: fcfBilinearFit? and something good: cubicFitGrad (or something like that)
	\item tests: A\&K stripes, Schaer waves, modified Schaer waves (so that the Lorenz mode shows up)
\end{itemize}
}
