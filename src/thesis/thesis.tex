...
\TODO{I wonder whether the model of the Euler equations should be introduced immediately prior to its use.  I could insert a new section before section~\ref{sec:slanted:resting} for this purpose.}
