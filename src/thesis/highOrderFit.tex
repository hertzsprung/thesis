...
\TODO{by what measure?  doesn't it depend on the nature of the flow? smooth, slowly-varying flows would suit higher order}
...
\TODO{also, unsteady flows, like in the deformational flow test, will result in filamentation and less smooth fields}
...
\TODO{John and Hans suggest that shock-capturing schemes are unnecessary for atmospheric flows, so highOrderFit is a well-motivated alternative to existing Godunov-type and WENO schemes.}
