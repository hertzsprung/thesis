...
\item We should get fourth-order convergence at least on cut cell meshes if not BTF meshes, hopefully for both horizontal and terrain-following velocity fields
