...
\TODO{Existing tests are unsuitable for modern dynamical cores
\begin{itemize}
	\item \citet{untch-hortal2004} is unsuitable because 600-day integration of 3D spherical Earth too slow
	\item \citet{arakawa-konor1996} tests are better but is designed for 1D vertically-discrete model
	\item \citet{hollingsworth1995}?
\end{itemize}
}
