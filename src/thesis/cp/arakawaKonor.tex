...
For the left-hand block of the horizontally tilted mesh, horizontal surfaces are distorted such that the ratio of minumum and maximum vertical edge lengths at $x = \SI{-300}{\kilo\meter}$ is \TODO{1:4}, and the ratio at $x = \SI{0}{\kilo\meter}$ is \TODO{4:1}.
The vertically tilted mesh is constructed a similar manner, with a ratio of minimum and maximum horizontal edge lengths at $z = \SI{0}{\kilo\meter}$ of \TODO{1:1.1}, and a ratio at $z = \SI{30}{\kilo\meter}$ of \TODO{1.1:1}.
