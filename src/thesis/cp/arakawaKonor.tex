...
%
	\caption{
	\TODO{What are the values that have been clipped in (f)?}
...
\TODO{John asks, how do I know that it is not the implementation of top and bottom boundary conditions on the distorted mesh that results in error growth?  Answer: I don't know exactly where the errors are coming from, but the boundaries are the same for distorted and undistorted meshes.  And the errors appear everywhere, they don't start at any boundary.  What makes you suspect the boundaries?}
