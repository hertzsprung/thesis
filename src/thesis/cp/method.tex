...
\rev{On a rectangular Cartesian mesh with no diagonal faces, $\theta_C$ is simply a linear interpolation from the face values immediately above and below the cell centre, and the generalised Charney--Phillips formulation reduces to the standard Charney--Phillips formulation.}
