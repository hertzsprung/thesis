...
The Lorenz computational mode arises from having one too many degrees of freedom in the Lorenz staggering of variables, and it is often excited by thermal forcing, producing spurious, vertical, \TODO{two-grid, alternating} grid-scale waves \citep{schneider1987,arakawa-konor1996}.
...
\TODO{John asks, is a key point here the move to nonhydrostatic models?  In hydrostatic models, vertical momentum equation is not prognostic and $w$ is not a prognostic variable.
Many of these hydrostatic models have worked well with Lorenz staggering (e.g. ECMWF)}
...
\TODO{John asks, why was a new test needed? What was deficient with the old ones?}
